<?php
	...
	if ( ! class_exists( 'Industrix_Menu_Walker' ) ):

		class Industrix_Menu_Walker extends Walker_Nav_Menu {
			...
			public static function fallback( $args ) {
				if ( current_user_can( 'manage_options' ) ) {
					$fb_output = '<li class="menu-item"><a href="' . esc_url( home_url( '/' ) ) . '">' . esc_html__( 'Home', 'industrix' ) . '</a></li>';
					$fb_output .= '<li class="menu-item"><a target="_blank" href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '">' . esc_html__( 'Add Menu', 'industrix' ) . '</a></li>';
